...
return (
  <div className="min-h-screen grid lg:grid-cols-2 font-['Outfit',sans-serif] bg-transparent">
  {/* Left Content Section */}
  <div className="relative hidden lg:flex flex-col justify-between bg-transparent p-12 text-zinc-100 overflow-hidden">
        {/* Subtle glow background */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-transparent rounded-full blur-3xl opacity-50 pointer-events-none" />
      ...
      <div className="flex items-center justify-center p-8 bg-transparent">
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-12">
            ...
            <span className="font-syne font-bold text-xl tracking-wider text-foreground">NEXUS<span className="text-primary-500">_</span>GATEWAY</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                href="#"
                className="text-sm text-primary-400 hover:text-white transition-colors font-medium"
              >
                Forgot password?
              </a>
            </div>
            ...
            {error && (
              <div className="p-3 text-sm text-rose-400 bg-rose-500/10 border border-rose-500/20 rounded-lg backdrop-blur-md">
                {error}
              </div>
            )}

<Button type="submit" variant="luxury" size="xl" className="w-full text-base font-semibold flex items-center justify-center" disabled={isLoading}>
  {isLoading ? (
    <>
