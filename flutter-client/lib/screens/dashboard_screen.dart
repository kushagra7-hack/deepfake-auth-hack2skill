        ...
        children: [
          Row(
            children: [
              ...
              Text(label, style: GoogleFonts.outfit(color: kGray600, fontSize: 9, letterSpacing: 0.5)),
            ],
          ),
          const SizedBox(height: 4),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(flex: 3, child: Text(scan.fileName, style: _tableRowStyle, overflow: TextOverflow.ellipsis)),
